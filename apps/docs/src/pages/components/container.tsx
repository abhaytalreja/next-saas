  ...
  return (
    <Container>
      <div className="bg-blue-100 p-8 rounded text-center">
        ...
        <p className="text-gray-600 mt-2">This content is contained within a responsive container with default max-width and padding.</p>
      </div>
    </Container>
  )
}
...
const SizesExample = () => {
  return (
    <div className="space-y-6">
      <div>
        <h4 className="text-sm font-medium text-gray-700 mb-2">Small Container</h4>
        <Container size="sm">
      ...
      <div>
        <h4 className="text-sm font-medium text-gray-700 mb-2">Medium Container</h4>
        <Container size="md">
      ...
      <div>
        <h4 className="text-sm font-medium text-gray-700 mb-2">Large Container</h4>
        <Container size="lg">
      ...
      <div>
        <h4 className="text-sm font-medium text-gray-700 mb-2">Extra Large Container</h4>
        <Container size="xl">
  ...
  return (
    <Container fluid>
      <div className="bg-purple-100 p-8 rounded text-center">
        ...
        <p className="text-gray-600 mt-2">This container takes the full width of its parent with no max-width constraint.</p>
      </div>
    </Container>
  )
}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <Container padding="none" className="border border-dashed border-gray-300">
      ...
      <div>
        <h4 className="text-sm font-medium text-gray-700 mb-2">Small Padding</h4>
        <Container padding="sm" className="border border-dashed border-gray-300">
      ...
      <div>
        <h4 className="text-sm font-medium text-gray-700 mb-2">Large Padding</h4>
        <Container padding="lg" className="border border-dashed border-gray-300">
  ...
  return (
    <Container centered>
      <div className="bg-green-100 p-8 rounded text-center max-w-md">
        ...
        <p className="text-gray-600 mt-2">This container centers its content horizontally and vertically.</p>
      </div>
    </Container>
  )
}
  ...
  return (
    <Container size="xl" className="bg-gray-50 py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Extra large container with nested containers</p>
      </div>
      ...
      <div className="space-y-6">
        <Container size="lg" className="bg-white rounded-lg shadow-sm">
          <div className="text-center py-6">
            ...
            <p className="text-gray-600 mt-2">This is a large container nested inside an extra large one.</p>
          </div>
        </Container>
        ...
        <Container size="md" className="bg-white rounded-lg shadow-sm">
          <div className="text-center py-6">
            ...
            <p className="text-gray-600 mt-2">This is a medium container also nested inside.</p>
          </div>
        </Container>
      </div>
    </Container>
