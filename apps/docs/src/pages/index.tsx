export default function DocsHomePage() {
  return (
    <div className="prose max-w-none">
      ...
      <div className="bg-gradient-to-r from-blue-100 to-blue-200 text-white rounded-xl p-8 mb-8 not-prose">
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-4">
            ⚡ Get Started in 5 Minutes
          </h2>
          <p className="text-lg mb-6">
            From zero to a fully functional SaaS with auth, database, and
            payments
          </p>
          <a
            href="/quickstart"
            className="inline-block bg-white text-blue-700 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors shadow-lg hover:shadow-xl"
          >
            Start Quick Setup →
          </a>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 not-prose mb-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm">
            Authentication, database, payments, and more - all configured and
            ready to deploy
          </p>
        </div>
        <div className="text-center">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm">
            TypeScript, ESLint, testing, CI/CD - everything configured properly
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 not-prose">
        <a
          href="/quickstart"
          className="block border-2 border-blue-200 bg-blue-50 rounded-lg p-4 hover:border-blue-400 transition-colors"
        >
      ...
      <div className="bg-gray-100 rounded-lg p-6 mt-8">
        ...
        <p className="text-gray-700">
          Start with the{' '}
          <a href="/quickstart" className="text-blue-600 font-semibold">
            5-minute quick start
          </a>{' '}
          to get everything running, then explore specific features as you need
          them. Most developers have their SaaS up and running before finishing
          their coffee! ☕
        </p>
      </div>
      ...
      <div className="text-center mt-12 pt-8 border-t">
        ...
        <div className="flex justify-center gap-4">
          <a
            href="https://github.com/yourusername/nextsaas"
