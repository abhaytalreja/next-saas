    ...
    return (
      <div className="p-6">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Manage your projects and workflows</p>
        </div>
      ...
      {projects.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <div key={project.id} className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
